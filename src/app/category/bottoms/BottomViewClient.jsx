...
const BottomsClientView = ({ initialBottoms }) => {
    ...
    const handleSort = (key) => {
        ...
        if (key === "low-to-high") {
            ...
            setBottoms(initialBottoms);
            setSelectedSort("Date (New > Old)");
            return;
        }
        setBottoms(sortedData);
    };

    return (
        <main className="mt-19 px-4 md:px-15 py-10">
                ...
                {bottoms.map((item,index) => (
                    ...
                    >
                        ...
                        <div className="pt-4 pb-2 space-y-2 flex-1 flex flex-col justify-between">
                            ...
                            <div className="pt-2">
                                <Link href={`/category/bottoms/${item.id}`} className="w-full block">
                                    <Button 
...
export default BottomsClientView;