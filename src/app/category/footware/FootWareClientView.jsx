...
const FootWareClientView = ({ initialfootware }) => {
    const [dresses, setDresses] = useState(initialfootware);
    const [selectedSort, setSelectedSort] = useState("Date (New > Old)");

 
    const handleSort = (key) => {
        let sortedData = [...dresses];
                ...
                {dresses.map((item,index) => (
                    ...
                    >
                        ...
                        <div className="pt-4 pb-2 space-y-2 flex-1 flex flex-col justify-between">
                            ...
                            <div className="pt-2">
                                <Link href={`/category/footware/${item.id}`} className="w-full block">
                                    <Button 
...
export default FootWareClientView;