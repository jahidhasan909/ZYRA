...
const PoloClientView = ({ initialPolo }) => {
    const [panjabis, setPanjabis] = useState(initialPolo);
    ...
    return (
        <main className="mt-19 px-4 md:px-14 py-10">
                ...
                {panjabis.map((item,index) => (
                    ...
                    >
                        ...
                        <div className="pt-4 pb-2 space-y-2 flex-1 flex flex-col justify-between">
                            ...
                            <div className="pt-2">
                                <Link href={`/category/polo/${item.id}`} className="w-full block">
                                    <Button 
